...
CSRF_TRUSTED_ORIGINS = ['https://ttime.softworksapp.cloud', 'https://ttime2.softworksapp.cloud']
...
ROOT_URLCONF = 'compose_vote.urls'
...
SECURE_SSL_REDIRECT = False  # 리다이렉트는 Ingress에서 하므로 False
